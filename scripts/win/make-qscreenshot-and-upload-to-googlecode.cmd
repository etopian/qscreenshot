...
call 7z a -mx9 "qscreenshot-r145-win32.7z" "qscreenshot.exe"
@echo Completed
pause
@echo Uploading archived qScreenshot Nightly Build to Google Code
call googlecode_upload.py -p "qscreenshot" -s "qScreenshot Nightly Build || Qt 4.8.5 || For test only!" -l "NightlyBuild,Windows,Archive" "qscreenshot-r145-win32.7z"
@echo Completed
pause & pause
